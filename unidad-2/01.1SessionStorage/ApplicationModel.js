...
class APIModelAccess
{
	constructor()
	{
        ...
        console.log("Contenido de 'authData' en sessionStorage:", sessionStorage.getItem('authData'));
        console.log("Contenido de 'authArticle' en sessionStorage:", sessionStorage.getItem('authArticle'));
		...
		if(this._authData.size === 0){
			...
			console.log("Datos cargados desde sessionStorage. No se inicializarán datos por defecto.");
		}
	}

	loadFromStorage(){
		const storedUsers = sessionStorage.getItem('authData');
		...
		const storedArticles = sessionStorage.getItem('authArticle');
	...
	saveToStorage(){
		...
		sessionStorage.setItem('authData', JSON.stringify(users));
		sessionStorage.setItem('authArticle', JSON.stringify(articles));
	}
