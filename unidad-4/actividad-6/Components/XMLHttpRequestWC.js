...
class XMLHttpRequestExample extends HTMLElement{
    constructor(){
        ...
        let modal = new ModalDialogWC();
        let modalController = new ModalDialogController(modal);
        let tableController = new TableController(null, modalController, httpHandler);

        this.tableElement = new TableWC(modal, modalController, tableController);
        tableController.table = this.tableElement;

        this.controller = new XMLHttpRequestController(this, this.tableElement);
